...
class Audit_trail {
	...
	public function log_audit_trail($activity, $module, $prev_detail = array(), $curr_detail = array(), $action_arr = array(), $table_arr = array(), $schema_arr = array(), $user_id=NULL)
	{	
		try 
		{			
			if(EMPTY($activity))
			...
			$trail["module"] 	= $module;
			//Added by kebs for offline email
