	...
	<div class="m-b-md m-t-md">
	  ...
	  <div class="row m-n">
        ...
        <div class="col s8">
			<div class="input-field m-n">
				...
				<input type="password" class="m-b-n" name="password" id="password" data-parsley-required="true" data-parsley-trigger="keyup" data-parsley-pass="true" placeholder="Password" value=""/>
			</div>	  
		</div>			  
        <div class="col s2">&nbsp;</div>
      </div>	
	  <div class="row m-n">
        ...
        <div class="col s8">
			<div class="input-field m-n">
				<i class="material-icons prefix">lock_outline</i>
				<input type="password" class="m-b-n" name="confirm_password" id="confirm_password" data-parsley-required="true" data-parsley-trigger="keyup" data-parsley-equalto-message="Password and Confirm Password do not match." data-parsley-equalto="#password" placeholder="Confirm Password" value=""/>
			</div>			  
