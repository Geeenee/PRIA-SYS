	...
	<!-- 	<div id="panel-slider" class="owl-carousel" style="width:290px;">
	  ...
	  <div class="right-panel">
		...
		<form id="reset-form">
		  ...
		  <div class="input-field">
		    <input id="retype_password" name="retype_password" data-parsley-required="true" data-parsley-validation-threshold="0" data-parsley-trigger="keyup" data-parsley-equalto="#password" type="password" class="validate" placeholder="Re-type password" />
