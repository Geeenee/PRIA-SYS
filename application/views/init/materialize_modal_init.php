				...
				<<?php echo $not_form ?> id="form_<?php echo $id; ?>">
					...
					<div class="modal-footer right-align">
						...
						<?php foreach ($custom_button as $key => $val): ?>
							<button type="<?php echo $val["type"] ?>" data-save="<?php echo SAVE_CLOSE ?>" id="submit_<?php echo $id; ?>" class="<?php $class_str = ( ISSET( $val['class'] ) ) ? $val['class'] : ""; echo $class_str ?> modal-action btn m-n" data-btn-action="<?php echo $val["action"]; ?>"><?php echo $key; ?></button>
						<?php endforeach; ?>	
						<?php 
							}
						?>	
...
?>		
		...
		<?php echo $id; ?>_init('<?php echo $given_url ?>', this, '<?php echo $custom_title ?>');
		...
		function <?php echo $id; ?>_init(data_id, obj, title_header)
		{
			...
			//alert('POST : ' + <?php echo $id; ?>);
			//console.log('POST :  <?php echo $id; ?>');
