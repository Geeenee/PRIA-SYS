	...
	<tr>
		...
		<td>
			<div class="input-field m-n">
				...
				<input type="checkbox" <?php echo $disable ?> <?php echo $check_admin ?> class="labelauty checkbox_members" id="checkbox_members_<?php echo $key ?>" name="group_admin_checks[]" data-labelauty="Member|Admin" />
			</div>
		</td>
...
<tr>
	...
	<td>
		<div class="input-field m-n">
			...
			<input <?php echo $disable ?> type="checkbox" class="labelauty checkbox_members" id="checkbox_members" name="group_admin_checks[]" data-labelauty="Member|Admin" />
		</div>
	</td>
	<td class="valign-middle">
		<div class="table-actions center">
