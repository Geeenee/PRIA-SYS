<div class="flat-tbl">
	<table id="tbl_dashboard_contractors" cellpadding="0" cellspacing="0" class="table table-default table-layout-auto scroll dataTable highlight" style="width: 100% !important;">
		<thead>
			<tr>
				<th>Created Date</th>
				...
				<th>BOQ Approval Date</th>
				<th>BOQ Progress Approval Date</th>
				<th>Approval Date of Project Completion Files</th>
				<th>APV Number</th>
				<th>APV Date</th>
				<th>APV Amount</th>
				<th>CV Number</th>
			...
			<tr class="table-filters">
				...
				<td><input type="text" name="po_number" class="form-filter" placeholder="Search PO number"/></td>
				<td><input type="text" name="po_approved_date" class="form-filter" placeholder="Search PO approval date"/></td>
				<td><input type="text" name="boq_approved_date" class="form-filter" placeholder="Search BOQ approval date"/></td>
				<td><input type="text" name="boq_progress_approved_date" class="form-filter" placeholder="Search BOQ progress approval date"/></td>
				<td><input type="text" name="project_completion_approved_date" class="form-filter" placeholder="Search approval date of project completion files"/></td>
