<div class="flat-tbl">
	<table id="tbl_dashboard_bavi" cellpadding="0" cellspacing="0" class="table table-default table-layout-auto scroll dataTable highlight" style="width: 100% !important;">
		<thead>
			<tr>
				<th>Created Date</th>
			...
			<tr class="table-filters">
				...
				<td><input type="text" name="po_amount" class="form-filter" placeholder="Search PO amount"/></td>
				<td><input type="text" name="dr_number" class="form-filter" placeholder="Search DR number"/></td>
				<td><input type="text" name="gr_number" class="form-filter" placeholder="Search GR number"/></td>
				<td><input type="text" name="invoice_date" class="form-filter" placeholder="Search invoice received date"/></td>
				<td><input type="text" name="invoice_number" class="form-filter" placeholder="Search invoice number"/></td>
