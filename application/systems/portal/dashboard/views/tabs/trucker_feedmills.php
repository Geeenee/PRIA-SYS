<div class="flat-tbl">
	<table id="tbl_dashboard_feedmills" cellpadding="0" cellspacing="0" class="table table-default table-layout-auto scroll dataTable highlight" style="width: 100% !important;">
		<thead>
			<tr>
				<th>Created Date</th>
			...
			<tr class="table-filters">
				...
				<td><input type="text" name="soa_upload_date" class="form-filter" placeholder="Search SOA upload date"/></td>
				<td><input type="text" name="soa_approval_date" class="form-filter" placeholder="Search SOA acknowledgement date"/></td>
