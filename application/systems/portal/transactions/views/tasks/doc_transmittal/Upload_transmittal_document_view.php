...
<div class="input-field m-n">
	<div class="row m-b-n p-n">
		...
		<?php
            ...
            ? 
            <<<EOS
                <div class="div-task-values">$date_release</div>
EOS
            : 
			<<<EOS
				<input type="text" class="datepicker" name="date_release" id="date_release" placeholder="Enter Date Release to Accounts Payable" data-parsley-required="true" value="$date_release" data-max-date="0"/>
EOS;
		?>
		</div> -->
	</div>
...
EOS
            : 
			<<<EOS
            <textarea id="remarks" name="remarks" class="materialize-textarea m-t-sm" style="min-height:100px; overflow: auto;">$remarks</textarea>    
EOS;
		?>
