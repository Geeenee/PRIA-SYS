...
<div class="input-field m-n">
    <div class="row m-b-n p-n">
        <div class="col l3 m4 s12 label-col  p-r-md">
            <label class="<?php echo $class_label ?>">Store Lay-Out Plan</label>
        </div>
...
<div class="input-field m-n">
    <div class="row m-b-n p-n">
        <div class="col l3 m4 s12 label-col  p-r-md">
            <label class="<?php echo $class_label ?>">Supporting Pictures</label>
        </div>
...
<div class="input-field m-n">
    <div class="row m-b-n p-n">
        ...
        <div class="col l9 m8 s12 ">
        <?php
            $layout_specifications = ( ISSET($boq_details['layout_specifications']) && ! EMPTY($boq_details['layout_specifications'])) ? (($view == TRUE)? nl2br($boq_details['layout_specifications']): $boq_details['layout_specifications']) : ''; 
...
EOS
            : 
            <<<EOS
            <textarea id="layout_specifications" name="layout_specifications" class="materialize-textarea m-t-sm" data-parsley-required="false" style="min-height:100px; overflow: auto;">$layout_specifications</textarea>    
EOS;
        ?>
