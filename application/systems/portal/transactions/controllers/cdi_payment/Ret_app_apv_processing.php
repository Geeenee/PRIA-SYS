...
class Ret_app_apv_processing extends Task_Controller
{
    ...
    private function _validate()
    {
        try
        {
            ...
            ->filter_string('apv_no')
            ->filter_date('apv_doc_date')
            ->filter_date('transmittal_date_to_bgc')
            ->filter();
            ...
            $required = [ 
                'apv_no'                  => 'APV No.',
                'apv_doc_date'            => 'APV Document Date',
                'transmittal_date_to_bgc' => 'Transmittal Date to BGC'
            ];
            ...
            $constraints['apv_doc_date']    = [
                'data_type' => 'date',
                'name'      => 'APV Document Date'
            ];

            $constraints['transmittal_date_to_bgc']    = [
                'data_type' => 'date',
                'name'      => 'Transmittal Date to BGC'
            ];
    ...
    private function _store_payment_info($payment_id, $params) 
    {
        ...
        $update       = [ 
            'apv_no'                  => $params['apv_no'],
            'apv_doc_date'            => $params['apv_doc_date'],
            'transmittal_date_to_bgc' => $params['transmittal_date_to_bgc']
        ];
