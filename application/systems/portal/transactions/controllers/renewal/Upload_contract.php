...
class Upload_contract extends Task_Controller 
{
    ...
    public function index()
    {
        try
        {
            ...
            $this->task_page                = '/upload_contract';
    ...
    public function process()
    {
        try
        {
            ...
            $ongoing             = $this->pria_workflow->tag_task_status($task_id, TASK_STATUS_ONGOING, ['reference' => $contract_details['contract_id']]);
