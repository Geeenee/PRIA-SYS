...
class Po extends Transaction_Controller 
{
	public function __construct()
	{
		parent::__construct();

		$this->module_code		= MODULE_PORTAL_IMPORT_REFERENCE_PO;
	...
	public function index()
	{
		try
		{
			...
			$resources['datatable']			= array(
					'path'					=> $this->module_folder .'/tabs/'. $this->controller .'/get_purchase_orders',
					'table_id'				=> 'tbl_purchase_orders',
	...
	public function get_purchase_orders()
	{
		...
		try
		{
			...
			$total_records		= $this->import_reference_model->get_purchase_orders_list();
			$records_info 		= $this->import_reference_model->get_purchase_orders_list($params);
