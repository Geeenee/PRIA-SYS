...
class Forwarders extends Transaction_Controller 
{
	private $module_js;
	...
	public function __construct()
	{
		...
		$this->module_code 	  		= MODULE_PORTAL_TRANS_FORWARDERS;
	...
	public function index()
	{
		try
		{
			...
			$resources['load_css']    				= array_merge([CSS_SELECTIZE, CSS_DATETIMEPICKER, CSS_LABELAUTY], $common_resource['css']);
			$resources['load_js']     				= array_merge([JS_SELECTIZE, JS_DATETIMEPICKER, JS_LABELAUTY, $this->module_task_js], $common_resource['js']);
			...
			$data['sub_nav_right'] 	 = ['display' => FALSE];
			
			// PAGE TITLE
			$data['active_sub_menu'] = MODULE_PORTAL_TRANSACTIONS;
			$data['page_title'] 	 = 'Forwarders';
