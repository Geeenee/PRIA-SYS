<div class="flat-tbl">
	<table id="tbl_dashboard_inbound_centralized" cellpadding="0" cellspacing="0" class="table table-default table-layout-auto scroll dataTable highlight" style="width: 100% !important;">
		<thead>
			<tr>
				<th>Created Date</th>
