<div class="flat-tbl">
	<table id="tbl_dashboard_outbound" cellpadding="0" cellspacing="0" class="table table-default table-layout-auto scroll dataTable highlight" style="width: 100% !important;">
		<thead>
			<tr>
				<th>Created Date</th>
				...
				<th>Vendor Name</th>
				<th>SOA Number</th>
				<th>SOA Submission Date</th>
				<th>SOA Approval Date</th>
				<th>APV Number</th>
				<th>APV Date </th>
				<th>APV Amount</th>
				<th>CV Number</th>
			...
			<tr class="table-filters">
				...
				<td><input type="text" name="soa_date" class="form-filter" placeholder="Search SOA submission date"/></td>
				<td><input type="text" name="acknowledgement_date" class="form-filter" placeholder="Search SOA approval date"/></td>
