<div class="flat-tbl">
	<table id="tbl_dashboard_forwarders" cellpadding="0" cellspacing="0" class="table table-default table-layout-auto scroll dataTable highlight" style="width: 100% !important;">
		<thead>
			<tr>
				<th>Created Date</th>
				...
				<th>Vendor Name</th>
				<th>SOA Number</th>
				<th>SOA Received Date at BAVI Office</th>
				<th>SOA Received Date at Crossing Calamba</th>
				<th>APV Number</th>
				<th>APV Date</th>
				<th>APV Amount</th>
				<th>CV Number</th>
			...
			<tr class="table-filters">
				...
				<td><input type="text" name="soa_date_bavi" class="form-filter" placeholder="Search SOA received date at BAVI office"/></td>
				<td><input type="text" name="soa_date_calamba" class="form-filter" placeholder="Search SOA received date at Crossing Calamba"/></td>
