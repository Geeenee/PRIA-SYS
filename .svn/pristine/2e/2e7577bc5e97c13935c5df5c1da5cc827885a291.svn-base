...
class Lessors extends Transaction_Controller 
{
	private $module_js;
	...
	public function __construct()
	{
		...
		$this->module_code 	  		= MODULE_PORTAL_TRANS_LESSORS;
	...
	public function index()
	{
		try
		{
			...
			$resources['load_css']    				= array_merge([CSS_SELECTIZE, CSS_LABELAUTY], $common_resource['css']);
			$resources['load_js']     				= array_merge([JS_SELECTIZE, JS_LABELAUTY, $this->module_task_js], $common_resource['js']);
