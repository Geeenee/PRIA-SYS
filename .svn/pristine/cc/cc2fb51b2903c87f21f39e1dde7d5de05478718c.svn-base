...
class Notify 
{
	...
	public function insert_notification($notification, $notify_who, $notify_by=NULL)
	{
		try
		{
			...
			$this->CI->notifications_model->insert_notification($params, $notify_by);
		}
	...
	public function insert_notification_helper_multi_user( $system, $message, array $val )
	{
		$id 		= array();
	...
	public function insert_notification_helper( $system, $message, array $val )
	{
		$id 		= array();
