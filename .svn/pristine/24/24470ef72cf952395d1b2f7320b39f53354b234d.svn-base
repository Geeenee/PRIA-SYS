<div class="flat-tbl">
	<table id="tbl_dashboard_lessors" cellpadding="0" cellspacing="0" class="table table-default table-layout-auto scroll dataTable highlight" style="width: 100% !important;">
		<thead>
			<tr>
				<th>Created Date</th>
			...
			<tr class="table-filters">
				...
				<td><input type="text" name="contract_number" class="form-filter" placeholder="Search contract reference number"/></td>
				<td><input type="text" name="store_name" class="form-filter" placeholder="Search store name"/></td>
				<td><input type="text" name="contract_upload_date" class="form-filter" placeholder="Search contract upload date"/></td>
				<td><input type="text" name="payment_term_name" class="form-filter" placeholder="Search payment term"/></td>
