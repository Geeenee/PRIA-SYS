...
<div class="input-field m-n b-t p-t-sm">
	<div class="row m-b-n p-n">
		<div class="col l3 m4 s12  label-col p-r-md">			
			<label class="">BCH Remarks on Recommendation</label>
		</div>

        <div class="col l9 m8 s12 ">
        <?php
            $sn_recom_bh = ( ISSET($contract_details['cn_recommendation_bh']) && ! EMPTY($contract_details['cn_recommendation_bh'])) ? nl2br($contract_details['cn_recommendation_bh']) : ''; 
...
<div class="input-field m-n b-t p-t-sm">
	<div class="row m-b-n p-n">
		<div class="col l3 m4 s12  label-col p-r-md">			
			<label class="">RH Remarks on Recommendation</label>
		</div>

        <div class="col l9 m8 s12 ">
        <?php
            $sn_recom_rh = ( ISSET($contract_details['cn_recommendation_rh']) && ! EMPTY($contract_details['cn_recommendation_rh'])) ? nl2br($contract_details['cn_recommendation_rh']) : ''; 
