...
<div class="input-field m-n">
    <div class="row m-b-n p-n">
        <div class="col l3 m4 s12 label-col  p-r-md">           
            <label class="view">Final <?php echo $reco_addtl_label; ?> Amount for Civil Works</label>
        </div>
...
<div class="input-field m-n">
    <div class="row m-b-n p-n">
        <div class="col l3 m4 s12 label-col p-r-md">            
            <label class="view">Final <?php echo $reco_addtl_label; ?> Amount for Signage</label>
        </div>
