var Files = function()
{
	...
	var init_modal 				= function( file_type, module, multi_check )
	{
		...
		)
		{
			...
			save_attr[ FILE_TYPES.FILE_TYPE_DOCUMENTS ] 	= {
				...
				field_ids 	: [ '#file_display_name', '#document' ],
			...
			save_attr[ FILE_TYPES.FILE_TYPE_VIDEOS ] 	= {
				...
				upload_obj 	: undefined,
				upload_options : undefined,
				field_ids 	: [ '#file_display_name', '#videos' ],
				field_label : [ 'Display Name', 'File' ]
			}
			...
			save_attr[ FILE_TYPES.FILE_TYPE_AUDIOS ] 	= {
				...
				upload_obj 	: undefined,
				upload_options : undefined,
				field_ids 	: [ '#file_display_name', '#audios' ],
				field_label : [ 'Display Name', 'File' ]
			}
			...
			save_attr[ FILE_TYPES.FILE_TYPE_IMAGES ] 	= {
				...
				upload_obj 	: undefined,
				upload_options : undefined,
				field_ids 	: [ '#file_display_name', '#images' ],
				field_label : [ 'Display Name', 'File' ]
			}
	...
	var trigger_access_rights 	= function( details, file_type )
	{
		...
		btn.on('click', function( e )
		{
			...
			dynamic_parsley( details[file_type]['field_ids'], details[file_type]['field_label'], '#'+file_type+'_access_rights_btn_modal' );
	...
	return {
		...
		datatable_custom_option : function( options )
		{
			var opt 	= datatable_custom_option( options );
